...
<head>
    ...
    <title>SAT - Sport of Agrotechnology</title>
...
<body>
    ...
    <section class="main-header">
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="img/logo/logo-SAT.png" class="img-responsive" alt="logo" width="66" height="66"></a>
                </div>
                <div class="collapse navbar-collapse text-center" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="social-media hidden-sm hidden-xs">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="https://twitter.com/SATUGM/" target="blank"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.instagram.com/SAT_ugm/" target="blank"><i class="fa fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="owl-hero" class="owl-carousel owl-theme">
            <div class="item" style="background-image: url(img/sliders/slide-13.jpg)">
                <div class="caption">
                    <img src="img/logo/logo-SAT.png" class="img-responsive center-block" alt="logo" width="150" height="150">
                    <h1>We Are <span>SAT</span></h1>
                </div>
            </div>
            ...
            <div class="item" style="background-image: url(img/sliders/slide-3.jpg)">
                <div class="caption">
                    ...
                    <a class="btn btn-transparent" href="http://SAT.tp.ugm.ac.id/main/fooshion-market/">Learn More</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="welcome">
        <div class="container">
            <h2>We are <span>SAT</span></h2>
            <hr class="sep">
            <p>Sport of Agrotechnology</p>
            <p>Universitas Gadjah Mada</p>
            <img class="img-responsive center-block wow fadeInUp" data-wow-delay=".3s" src="img/logo/SAT-lengkap.png" width="175" height="175" alt="logo">
        </div>
    </section>
...
<!-- Events -->
    <section id="team">
        <div class="container">
            <h2>Events</h2>
            <hr class="sep">
            <p>Event yang diadakan oleh SAT</p>
    ...
    <section id="services">
        <div class="container">
            <h2>Departemen</h2>
            <hr class="light-sep">
            <p>Satu Misi Satu Visi Memajukan SAT</p>
    ...
    <section id="portfolio">
        <div class="container-fluid">
            <h2>Galeri</h2>
            <hr class="sep">
            <p>Dokumentasi Kegiatan SAT</p>
            <div class="row">
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <a class="portfolio-box" href="img/portfolio/galeri-1.jpg" data-lightbox="image-1" data-title="Angkringan SAT pada acara SATrty">
                ...
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <a href="img/portfolio/galeri-6.jpg" class="portfolio-box" data-lightbox="image-6" data-title="Apel untuk memperingati hari jadi SAT">
...
<!--links -->
   <section id="links">
        <div class="container">
            ...
            <div class="row wow fadeInUp" data-wow-delay=".3s">
                <div class="col-lg-4">
                    ...
                    <h2 class="number timer">Profil SAT</h2>
                ...
                <div class="col-lg-4">
                    ...
                    <h5 style="margin-bottom: 30px">Data Anggota SAT, dan Lokasi Kerja Praktek</h5>
                    <a class="btn btn-transparent" href="/main/category/links/database/">Learn More</a>
                </div>
                <div class="col-lg-4">
                    <span class="icon-newspaper"></span>
                    <h2 class="number timer">Biptech</h2>
                    <h5 style="margin-bottom: 30px">Majalah berisi info seputar SAT dan TIP</h5>
    ...
    <footer>
        <div class="container">
            <h2 style="color:white" >SAT UGM</h2>
            <div class="social">
                <a href="#"><i class="fa fa-facebook fa-2x"></i></a>
                <a href="#"><i class="fa fa-twitter fa-2x"></i></a>
                <a href="#"><i class="fa fa-instagram fa-2x"></i></a>
            </div>
            <h6>&copy; 2016 Web.SAT.UGM By <a href="https://www.facebook.com/Wildan.ar.rahman">w1lldone</a> & <a href="https://facebook.com/bagas95waras">BGZ</a> - PSI</h6>
        </div>
    </footer>
